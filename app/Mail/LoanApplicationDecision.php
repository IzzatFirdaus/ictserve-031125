...
/**
 * Loan Application Decision Email
 *
 * Sent to applicants when their loan application is approved or declined.
 * Provides decision details and next steps.
 *
 * @component Email Template
 *
 * @description WCAG 2.2 AA compliant email notification for approval decisions
 *
 * @author Pasukan BPM MOTAC
 *
 * @trace D03-FR-002.1 Email approval workflow
 * @trace D03-FR-009.1 Automated email notifications
 * @trace Requirements 1.4, 10.1, 12.3, 12.4, 18.1, 18.2
 *
 * @wcag_level AA
 *
 * @version 1.0.0
...
class LoanApplicationDecision extends Mailable implements ShouldQueue
{
	...
	public function envelope(): Envelope
	{
		$subjectKey = $this->approved
			? 'loan.email.application_approved_subject'
			: 'loan.email.application_rejected_subject';
