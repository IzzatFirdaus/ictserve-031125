...
/**
 * AI Streaming Chunk Event
 *
 * Broadcasts individual response chunks during AI streaming for progressive display.
 ...
 * @see .kiro/specs/realtime-notifications-broadcasting/requirements.md - Requirements 6.2
 */
class AiStreamingChunk implements ShouldBroadcast
{
