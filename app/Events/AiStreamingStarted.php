...
/**
 * AI Streaming Started Event
 *
 * Broadcasts when an AI response starts generating for real-time streaming display.
 ...
 * @see .kiro/specs/realtime-notifications-broadcasting/requirements.md - Requirements 6.1
 */
class AiStreamingStarted implements ShouldBroadcast
{
