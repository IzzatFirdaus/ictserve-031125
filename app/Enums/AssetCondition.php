...
enum AssetCondition: string
{
    ...
    {
        $key = match ($this) {
            self::EXCELLENT => 'asset.condition.excellent',
            self::GOOD => 'asset.condition.good',
            self::FAIR => 'asset.condition.fair',
            self::POOR => 'asset.condition.poor',
            self::DAMAGED => 'asset.condition.damaged',
        };
