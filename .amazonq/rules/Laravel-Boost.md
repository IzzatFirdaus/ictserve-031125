...
applyTo:
  - '**'
description: |
  Laravel Boost AI coding standards for ICTServe project.
  Curated by Laravel maintainers for Laravel 12, Livewire 3, Filament 4.
  Defines conventions, tools, and best practices for AI-assisted development.
tags:
  - laravel-boost
  - ai-coding
  - conventions
...
# Laravel Boost — AI Coding Standards
...
- php - 8.2.12
- filament/filament (FILAMENT) - v4.1.10
- laravel/framework (LARAVEL) - v12.40.1
- laravel/prompts (PROMPTS) - v0.3.8
- laravel/reverb (REVERB) - v1.6.2
...
- [ ] Write tests for all changes (feature or unit)
