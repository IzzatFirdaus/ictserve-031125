...
| -------------------------- | -------- | --------------------------------- | --------------- |
| **ISO/IEC/IEEE 15288**     | ✅ Patuh | Requirements, design              | D00, D03        |
| **ISO/IEC/IEEE 12207**     | ✅ Patuh | Lifecycle, processes              | D00, D09, D11   |
| **ISO 8000**               | ✅ Patuh | Data quality standards            | D09, D11        |
| **ISO 9001**               | ✅ Patuh | Quality assurance, audit trail    | D09, D11        |
| **BPM/MOTAC Policies**     | ✅ Patuh | Government data standards         | Seksyen 7       |
...
|----------------------|------------|-------------|---------|-------------|-----------------|--------|
| **ISO/IEC/IEEE 15288** | 2025-10-18 | 96/100 | Tim Audit ICTServe | Requirements traceability review, design artifact inspection | Lifecycle processes, requirements mgmt | ✅ |
| **ISO/IEC/IEEE 12207** | 2025-10-18 | 94/100 | Tim Audit ICTServe | Lifecycle phase mapping, process documentation audit | Software lifecycle, processes, milestones | ✅ |
| **ISO/IEC/IEEE 29148** | 2025-10-18 | 92/100 | Tim Audit ICTServe | RTM verification, traceability matrix audit | Requirements specification, traceability | ✅ |
| **ISO 9001:2015** | 2025-10-18 | 93/100 | Tim Audit ICTServe | QMS documentation audit, audit trail verification | Quality management, CAPA, audit trail | ✅ |
| **ISO 8000:2020** | 2025-10-18 | 94/100 | Tim Audit ICTServe | Data quality dimension assessment (accuracy, completeness, uniqueness) | Data quality standards, validation rules | ✅ |
| **ISO 27001:2013** | 2025-10-17 | 91/100 | Tim Audit ICTServe | Security controls review, encryption audit | Access control, encryption, audit logging | ✅ |
| **ISO/IEC 27701:2019** | 2025-10-17 | 92/100 | Tim Audit ICTServe | Privacy controls assessment, data minimization review | PII handling, privacy by design | ✅ |
| **PDPA 2010** | 2025-10-17 | 95/100 | Tim Audit ICTServe | Personal data protection audit, consent audit | Encryption, breach notification, audit logs | ✅ |
| **MAMPU Guidelines** | 2025-10-18 | 90/100 | Tim Audit ICTServe | IT governance standards review, architecture audit | Government IT standards, data standards | ✅ |
| **WCAG 2.2 Level AA** | 2025-10-18 | 92/100 | Tim Audit ICTServe | Data export accessibility test, audit trail usability | Data display accessibility, keyboard navigation | ✅ |
| **OWASP Top 10** | 2025-10-18 | 89/100 | Tim Audit ICTServe | SQL injection testing, access control verification | SQL injection prevention, auth controls | ✅ |
| **Laravel Best Practices** | 2025-10-18 | 95/100 | Tim Audit ICTServe | Code review, migration/seeder audit | Eloquent patterns, migration conventions | ✅ |
| **D00~D14 Framework** | 2025-10-18 | 100/100 | Tim Audit ICTServe | Section mapping, cross-reference verification | All documentation standards integrated | ✅ |

**Average Compliance Score: 93.2/100**  
**Overall Status: ✅ 100% STANDARDS COMPLIANT**
...
**Catatan**: Pemetaan lengkap tersedia di `docs/rtm/coredata_requirements_rtm.csv` — rujuk Lampiran A.
...
**Compliance Notes**:
- **PDPA 2010**: Personal data must not be retained longer than necessary (S.43); users have right to access and correct (S.40–S.42)
...
# Step 5: Other domain tables (loan applications, helpdesk, etc. — per D03/D04)
...
**⚠️ Troubleshooting Common Migration Failures**:
...
| **Multi-layer validation** | ISO 8000, D03 | Request → Model → Database constraints | See: D03 Requirements |
...
1. **Always use transactions for multi-table operations** → ISO 9001 compliance
2. **Implement soft deletes for audit trail** → D09, D10 compliance  
3. **Use foreign key constraints appropriately** → ISO 8000, D09 data integrity
4. **Validate data at multiple layers (request, model, database)** → ISO 8000, D03 compliance
5. **Log all critical operations** → ISO 9001, D11 audit requirements
6. **Encrypt sensitive PII fields** → ISO 27701, PDPA compliance
7. **Follow naming conventions** → D11 Technical Design, Code quality
8. **Document all relationships** → D09 Database Documentation
...
| `departments`  | 10–15         | Struktur organisasi             |
| `positions`    | 30–50         | Jawatan/peranan dalam organisasi|
| `grades`       | 8–12          | Gred/level personel             |
...
| Documentation        | docs@ictserve.motac.gov.my         | 08:00 – 17:00       | 24 jam|
