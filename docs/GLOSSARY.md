...
| **MVC**                        | _Model-View-Controller_ - Corak seni bina perisian yang memisahkan logik aplikasi                                    | Teknikal - Seni Bina        |
...
### Dokumentasi D00-D14 (Standard Documentation)
...
- **helpdesk-system-flow.md** - Aliran kerja Helpdesk
- **asset-loan-system-flow.md** - Aliran kerja Asset Loan
