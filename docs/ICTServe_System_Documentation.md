...
> Notis Penggunaan Dalaman: Sistem ICTServe/ iServe adalah untuk kegunaan dalaman Kementerian Pelancongan, Seni dan Budaya (MOTAC) sahaja dan tidak ditujukan untuk kegunaan awam (internal use only).
...
- [Dokumentasi Aliran Sistem Meja Bantuan & Meja Perkhidmatan](<./helpdesk-system-flow.md>)
- [Dokumentasi Aliran Sistem Permohonan Pinjaman Aset ICT](<./asset-loan-system-flow.md>)
