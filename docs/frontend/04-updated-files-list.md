...
### `resources/views/livewire/loan/`

- [x] `application-wizard-view.blade.php`
- [x] `approval-page.blade.php`
- [x] `guest-application-form.blade.php`

### `resources/views/livewire/loan/partials/`

- [x] `step-3-assets.blade.php`
- [x] `step-4-dates.blade.php`
...
### `resources/views/livewire/navigation/`

- [x] `portal-navigation.blade.php`
