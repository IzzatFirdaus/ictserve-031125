...
<div class="mb-4" x-data="{ charCount: <?php echo e(strlen(old($name, $value))); ?> }">
    ...
    <textarea name="<?php echo e($name); ?>" id="<?php echo e($inputId); ?>" rows="<?php echo e($rows); ?>" class="<?php echo e($textareaClasses); ?>"
        ...
        <?php if($showCharCount): ?> x-on:input="charCount = $event.target.value.length" <?php endif; ?>
        <?php echo e($attributes->except(['id', 'class'])); ?>><?php echo e(old($name, $value)); ?></textarea>

    <!--[if BLOCK]><![endif]--><?php if($showCharCount && $maxlength): ?>
        <p id="<?php echo e($charCountId); ?>" class="mt-1 text-sm text-gray-600" aria-live="polite">
            <span x-text="charCount"></span> / <?php echo e($maxlength); ?> <?php echo e(__('characters')); ?>
...
<?php /**PATH C:\XAMPP\htdocs\ictserve-031125\resources\views/components/form/textarea.blade.php ENDPATH**/ ?>