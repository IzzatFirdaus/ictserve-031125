...
<body>
    ...
    <div class="summary-stats">
        <h3>{{ __('reports.summary_statistics') }}</h3>
        <div class="stat-grid">
            <div class="stat-item">
                <div class="stat-value">{{ $statistics['total'] }}</div>
                <div class="stat-label">{{ __('reports.total_applications') }}</div>
            </div>
            <div class="stat-item">
            ...
            <div class="stat-item">
                ...
                <div class="stat-label">{{ __('reports.in_use') }}</div>
            </div>
            <div class="stat-item">
    ...
    <h3>{{ __('reports.applications_breakdown') }}</h3>
    <table>
        <thead>
            <tr>
                <th>Application #</th>
