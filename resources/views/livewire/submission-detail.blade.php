...
<div>
    <div class="space-y-6">
        ...
        @if (session()->has('success'))
            <div class="rounded-lg bg-success-50 dark:bg-success-900/20 p-4 border-l-4 border-success-500"
                            ...
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                                <span class="inline-flex items-center gap-2">
                                    <x-heroicon-o-chat-bubble-left-right
                                        class="h-5 w-5 text-gray-500 dark:text-gray-400" aria-hidden="true" />
