    ...
    <main id="main-content" class="max-w-4xl mx-auto" tabindex="-1">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            @if($this->unreadCount > 0)
                <button
                    ...
                    class="btn-secondary min-h-11 px-4 py-2 rounded-m shadow-button
        ...
        <div role="log"
            ...
            @if($this->notifications->isEmpty())
                <!-- Empty State -->
                <div class="bg-white dark:bg-gray-800 rounded-l shadow-card p-12 text-center">
            ...
            @else
                ...
                @foreach($this->notifications as $notification)
                    <div class="bg-white dark:bg-gray-800 rounded-l shadow-card p-6
                ...
                @if($this->notifications->hasMorePages())
                    <div class="text-center mt-6">
                        <button
                            type="button"
                            wire:click="loadMore"
                            class="btn-secondary min-h-11 px-6 py-2 rounded-m shadow-button
                                   bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white
                                   hover:bg-gray-300 dark:hover:bg-gray-600
                                   focus-visible:ring-3 focus-visible:ring-gray-500 focus-visible:outline-none
