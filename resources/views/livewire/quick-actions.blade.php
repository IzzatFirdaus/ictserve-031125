        ...
        @foreach($this->visibleActions as $action)
            <a href="{{ route($action['route']) }}"
               @class([
                   ...
                   'bg-gray-50 dark:bg-gray-900/20 hover:bg-gray-100 dark:hover:bg-gray-900/30 border border-gray-200 dark:border-gray-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-gray-500 dark:focus-visible:ring-gray-800/50' => $action['color'] === 'secondary',
