        ...
        @foreach($this->visibleActions as $action)
            <a href="{{ route($action['route']) }}"
               @class([
                   ...
                   'bg-primary-50 dark:bg-primary-900/20 hover:bg-primary-100 dark:hover:bg-primary-900/30 border border-primary-200 dark:border-primary-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-800/50' => $action['color'] === 'primary',
                   'bg-success-50 dark:bg-success-900/20 hover:bg-success-100 dark:hover:bg-success-900/30 border border-success-200 dark:border-success-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-success-500 dark:focus-visible:ring-success-800/50' => $action['color'] === 'success',
                   'bg-info-50 dark:bg-info-900/20 hover:bg-info-100 dark:hover:bg-info-900/30 border border-info-200 dark:border-info-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-info-500 dark:focus-visible:ring-info-800/50' => $action['color'] === 'info',
                   'bg-slate-50 dark:bg-slate-900/20 hover:bg-slate-100 dark:hover:bg-slate-900/30 border border-slate-200 dark:border-slate-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-slate-500 dark:focus-visible:ring-slate-800/50' => $action['color'] === 'secondary',
                   'bg-warning-50 dark:bg-warning-900/20 hover:bg-warning-100 dark:hover:bg-warning-900/30 border border-warning-200 dark:border-warning-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-warning-500 dark:focus-visible:ring-warning-800/50' => $action['color'] === 'warning',
                   'bg-danger-50 dark:bg-danger-900/20 hover:bg-danger-100 dark:hover:bg-danger-900/30 border border-danger-200 dark:border-danger-800 focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-danger-500 dark:focus-visible:ring-danger-800/50' => $action['color'] === 'danger',
               ])
