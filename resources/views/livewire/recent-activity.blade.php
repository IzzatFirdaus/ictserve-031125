    ...
    <div class="flex items-center justify-between">
        ...
        @if ($activityType !== 'all' || $dateFrom || $dateTo || $search)
            <button wire:click="clearFilters"
                class="px-3 py-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg transition-colors focus:outline-none focus-visible:ring-3 focus-visible:ring-slate-300 focus-visible:ring-offset-2 dark:focus-visible:ring-slate-600 min-h-11 min-w-11"
            ...
            <div>
                ...
                <select wire:model.live="activityType" id="activityType"
                    ...
                    @foreach ($availableActivityTypes as $value => $label)
                        <option wire:key="activity-type-{{ $value }}" value="{{ $value }}">
                            {{ $label }}</option>
                    @endforeach
                </select>
            </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
        @if ($activities->isEmpty())
            ...
            <div class="p-12 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-slate-400 dark:text-slate-600"
