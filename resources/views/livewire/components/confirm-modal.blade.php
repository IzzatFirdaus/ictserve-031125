    ...
    <div x-show="$wire.isOpen" x-cloak x-transition:enter="transition ease-out duration-200"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div x-ref="modal" x-show="$wire.isOpen" x-transition:enter="transition ease-out duration-200"
                ...
                class="relative bg-white dark:bg-gray-800 rounded-l shadow-xl max-w-md w-full overflow-hidden">
                ...
                <div class="p-6 pb-4">
                    <div class="flex items-start gap-4">
                        ...
                        <button type="button" wire:click="close"
                            class="shrink-0 p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-m focus:outline-none focus:ring-2 focus:ring-primary-500"
                            aria-label="Tutup">
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 flex justify-end gap-3">
                    <button type="button" wire:click="close"
                        class="px-4 py-2 min-h-11 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-m hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
                        :disabled="$wire.isProcessing">
                        {{ $cancelText }}
                    </button>
                    <button type="button" wire:click="confirm" wire:loading.attr="disabled"
                        @class([
                            'px-4 py-2 min-h-11 text-white rounded-m focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
