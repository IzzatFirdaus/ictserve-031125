                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-center">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white" aria-label="Sembang AWS Bedrock">
                            Sembang <span class="text-orange-500">AWS Bedrock</span>
                        </h2>
                        @if ($context === 'faq')
                    ...
                    <div>
                        ...
                        <select id="model-select" wire:model.live.debounce.150ms="model"
                            ...
                            <optgroup label="Amazon Titan">
                                <option value="titan_text_lite">Titan Text Lite (Ringan)</option>
                ...
                <div id="messages-list" role="log" aria-live="polite" aria-relevant="additions"
                    ...
                    @forelse($messages as $message)
                        <div class="mb-4 flex {{ $message['role'] === 'user' ? 'justify-end' : 'justify-start' }}"
                            ...
                            <div
                                class="max-w-[80%] p-4 rounded-lg shadow-lg {{ $message['role'] === 'user' ? 'bg-linear-to-r from-orange-500 to-orange-600 text-white' : 'bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-orange-900/30 text-gray-900 dark:text-gray-100' }}">
