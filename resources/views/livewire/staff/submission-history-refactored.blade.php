        ...
        <div class="mb-6 flex flex-col sm:flex-row gap-4">
            <div class="flex-1">
                ...
                <div class="relative">
                    ...
                    />
                    <x-heroicon-o-magnifying-glass class="w-5 h-5 text-gray-400 absolute left-3 top-3 pointer-events-none" aria-hidden="true" />
                </div>
            </div>
            ...
            <div class="flex gap-2">
                <select
                    ...
                    class="form-select rounded-m border border-gray-300 dark:border-gray-600
                           bg-white dark:bg-gray-700 text-gray-900 dark:text-white
                           shadow-sm focus:border-primary-500 focus:ring-primary-500
                           focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:outline-none
        ...
        <div class="bg-white dark:bg-gray-800 rounded-l shadow-card overflow-hidden">
            @if($this->submissions->isEmpty() && empty($this->search))
                ...
                <div class="p-12 text-center">
                    <x-heroicon-o-document-text class="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" aria-hidden="true" />
                    ...
                    <a href="{{ route('helpdesk.submit') }}"
                       class="btn-primary min-h-11 px-6 py-2 rounded-m shadow-button
            ...
            @elseif($this->submissions->isEmpty() && !empty($this->search))
                <!-- No Search Results -->
                <div class="p-12 text-center">
                    <x-heroicon-o-magnifying-glass class="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" aria-hidden="true" />
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">
