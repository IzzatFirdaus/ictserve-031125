<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div
                class="text-center p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg border border-primary-200 dark:border-primary-800">
            ...
            <div
                class="text-center p-4 bg-success-50 dark:bg-success-900/20 rounded-lg border border-success-200 dark:border-success-800">
            ...
            <div
                class="text-center p-4 bg-warning-50 dark:bg-warning-900/20 rounded-lg border border-warning-200 dark:border-warning-800">
            ...
            <div
                class="text-center p-4 bg-danger-50 dark:bg-danger-900/20 rounded-lg border border-danger-200 dark:border-danger-800">
    ...
    <div
        ...
        <div class="flex">
            <div class="shrink-0">
                <svg class="h-5 w-5 text-primary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
        ...
        <form wire:submit="searchSubmissions" class="space-y-4">
            <div>
                ...
                <div class="mt-1 flex rounded-lg shadow-sm">
                    <input type="email" id="searchEmail" wire:model="searchEmail"
                    ...
                    <button type="submit"
                        ...
                        wire:loading.attr="disabled" wire:target="searchSubmissions"
    ...
    @if ($successMessage)
        <div class="bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-lg p-4 mb-6"
            ...
            <div class="flex">
                <div class="shrink-0">
                    <svg class="h-5 w-5 text-success-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-success-800 dark:text-success-200">{{ $successMessage }}</p>
                </div>
            </div>
        </div>
    @endif
    ...
    @if ($errorMessage)
        <div class="bg-danger-50 dark:bg-danger-900/20 border border-danger-200 dark:border-danger-800 rounded-lg p-4 mb-6"
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-danger-800 dark:text-danger-200">{{ $errorMessage }}</p>
                </div>
            </div>
        </div>
    @endif
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2">
                                    ...
                                    @if ($submission['type'] === 'ticket')
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-info-100 text-info-800 dark:bg-info-900/30 dark:text-info-300">
                                    ...
                                    @else
                                        <span
                                            ...
                                            <svg class="mr-1 h-3 w-3" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path
                                                    d="M1 4.25a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0119 4.25v11.5A2.25 2.25 0 0116.75 18H3.25A2.25 2.25 0 011 15.75V4.25zM3.25 3.5a.75.75 0 00-.75.75v.5h15v-.5a.75.75 0 00-.75-.75H3.25zM2.5 6.5v9.25c0 .414.336.75.75.75h13.5a.75.75 0 00.75-.75V6.5h-15z" />
                                            </svg>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <button type="button" wire:click="resetSearch"
                            class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 min-h-11">
                            {{ __('common.cancel') }}
                        </button>
                        <button type="button" wire:click="linkSubmissions" wire:loading.attr="disabled"
                            wire:target="linkSubmissions" @disabled($this->selectedCount === 0)
                            class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-primary-600 border border-transparent rounded-lg hover:bg-primary-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors min-h-11"
    ...
    <div class="mt-6 text-center">
        <a href="{{ route('dashboard') }}"
            class="inline-flex min-h-11 items-center rounded-lg px-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2">
