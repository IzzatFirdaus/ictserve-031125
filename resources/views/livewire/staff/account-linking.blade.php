<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- Success Message --}}
    @if ($successMessage)
        <div class="bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-lg p-4 mb-6" role="alert">
            <div class="flex">
                <div class="shrink-0">
    ...
    {{-- Error Message --}}
    @if ($errorMessage)
        <div class="bg-danger-50 dark:bg-danger-900/20 border border-danger-200 dark:border-danger-800 rounded-lg p-4 mb-6" role="alert">
            <div class="flex">
                <div class="shrink-0">
