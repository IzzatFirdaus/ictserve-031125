                            ...
                            <div class="flex items-center space-x-3">
                                <input type="file" wire:model="profilePicture" id="profilePicture"
                                    ...
                                    class="block w-full text-sm text-slate-300
                                              ...
                                              bg-slate-800
                                              focus:outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
                            </div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center space-x-3 cursor-pointer">
                            <input type="radio" wire:model.live="emailFrequency" wire:change="updateEmailFrequency"
                                ...
                                class="h-4 w-4 text-blue-600 border-slate-600 bg-slate-800 focus-visible:ring-3 focus-visible:ring-blue-500 focus:ring-offset-slate-900">
                            <span
