...
<div class="py-6 theme-transition">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                <h1
                    class="text-2xl font-heading font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:truncate theme-transition">
                    {{ __('common.dashboard') }}
                ...
                <div class="bg-slate-800/50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('helpdesk.authenticated.tickets') }}"
                            class="inline-block py-3 font-medium text-primary-300 hover:text-primary-200 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950">
                            {{ __('common.view_all') }}
                        </a>
                    </div>
                </div>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    ...
                                    @if ($overdueCount === 0)
                                        <span
                                            class="ml-2 text-xs text-success-300">{{ __('common.all_clear') }}</span>
                                    @endif
                                </dd>
                            </dl>
                        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div wire:loading.remove wire:target="$refresh">
                        @if ($this->recentTickets->isEmpty())
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ route('helpdesk.authenticated.tickets') }}"
                                    class="inline-block py-3 text-sm font-medium text-primary-300 hover:text-primary-200 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950">
                                    {{ __('common.view_all') }}
                                </a>
                            </div>
                        @else
        ...
        {{-- Loading State --}}
        <div wire:loading wire:target="refreshData" role="status" aria-live="polite"
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-lg p-6 shadow-xl">
                <div class="flex items-center space-x-3">
                    <svg class="animate-spin h-5 w-5 text-primary-400" xmlns="http://www.w3.org/2000/svg"
