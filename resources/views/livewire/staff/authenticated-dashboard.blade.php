...
<div class="py-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div data-testid="dashboard-stats-grid" class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4"
            ...
            <div class="bg-slate-900/70 backdrop-blur-sm border {{ ($this->statistics['overdue_items'] ?? 0) > 0 ? 'border-red-800/50' : 'border-slate-800' }} overflow-hidden shadow rounded-lg"
                wire:loading.remove wire:target="$refresh">
                <div class="p-5">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            @if (($this->statistics['overdue_items'] ?? 0) > 0)
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-slate-100">
                                        {{ $this->statistics['overdue_items'] ?? 0 }}
                                    </div>
                                    @if (($this->statistics['overdue_items'] ?? 0) === 0)
