<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="flex-1 min-w-0">
            <h1 class="text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:truncate">
                ...
                @if ($unreadCount > 0)
                    <span
                        class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-danger-100 dark:bg-danger-900/50 text-danger-800 dark:text-danger-200"
    ...
    <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
        ...
        {{-- Notification List with ARIA Live Region for Screen Readers --}}
        <ul role="list" aria-live="polite" aria-atomic="false" aria-relevant="additions removals"
            class="divide-y divide-gray-200 dark:divide-gray-700">
            @forelse($notifications as $notification)
                <li
                    class="relative hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-all duration-150 ease-in-out {{ !$notification->is_read ? 'bg-primary-50/50 dark:bg-primary-900/10 border-l-4 border-primary-500' : '' }}">
                            ...
                            <div class="ml-3 flex-1">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-2 shrink-0 flex">
                                        <span
                                            class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full {{ !$notification->is_read ? 'bg-success-100 dark:bg-success-900/50 text-success-800 dark:text-success-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300' }}">
                                ...
                                <div class="mt-2 sm:flex sm:justify-between">
                                    <div class="sm:flex">
                                        <p class="flex items-center text-xs text-gray-500 dark:text-gray-400">
                                            <svg class="shrink-0 mr-1.5 h-4 w-4 text-gray-400 dark:text-gray-500"
