    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label for="loanStartDate" class="block text-sm font-medium text-gray-700 mb-1">
                {{ __('loan.fields.loan_start_date') }} <span class="text-red-500">*</span>
            </label>
            <input
                type="date"
                id="loanStartDate"
                ...
                @class([
                    ...
                    'border-red-300' => $errorBag->has('loanStartDate'),
            ...
            @enderror
            @if ($minDateMessage)
                <p class="mt-1 text-sm text-amber-600">{{ $minDateMessage }}</p>
            @endif
        </div>

        <div>
            <label for="loanEndDate" class="block text-sm font-medium text-gray-700 mb-1">
                {{ __('loan.fields.loan_end_date') }} <span class="text-red-500">*</span>
            </label>
            <input
                type="date"
                id="loanEndDate"
                ...
                @class([
                    'block w-full rounded-md shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm',
                    'border-red-300' => $errorBag->has('loanEndDate'),
            ...
            <div class="mt-4 space-y-4 animate-fadeIn">
                ...
                <div>
                    <label for="emergencyJustification" class="block text-sm font-medium text-gray-700 mb-1">
                        {{ __('loan.fields.emergency_justification') }} <span class="text-red-500">*</span>
                    </label>
                    <textarea
                        ...
                        @class([
                            'block w-full rounded-md shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm',
                            'border-red-300' => $errorBag->has('emergencyJustification'),
