...
<div class="space-y-6">
    ...
    <nav class="flex items-center gap-2 flex-wrap" role="tablist" aria-label="{{ __('Tapis pemberitahuan') }}">
        <button type="button" wire:click="filterBy('all')" role="tab"
            ...
            @class([
                'min-h-11 min-w-11 px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900',
