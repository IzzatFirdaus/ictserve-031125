...
<div class="space-y-6">
    ...
    <nav class="flex items-center gap-2 flex-wrap" role="tablist" aria-label="{{ __('Tapis pemberitahuan') }}">
        <button type="button" wire:click="filterBy('all')" role="tab"
            ...
            @class([
                'min-h-10 px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900',
    ...
    {{-- Notification List --}}
    <div id="notification-list" role="tabpanel" aria-label="{{ __('Senarai pemberitahuan') }}"
        class="bg-white dark:bg-gray-800 rounded-lg shadow-card border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex flex-col gap-2 items-end shrink-0">
                        @if (!$n->read_at)
                            <button type="button" wire:click="markAsRead('{{ $n->id }}')"
                                class="min-h-8 px-3 py-1 text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors duration-150"
