...
<div class="space-y-6">
    ...
    <nav class="flex items-center gap-2 flex-wrap" role="tablist" aria-label="{{ __('Tapis pemberitahuan') }}">
        <button type="button" wire:click="filterBy('all')" role="tab"
            ...
            @class([
                'min-h-11 min-w-11 px-4 py-2.5 text-sm font-medium rounded-lg transition-colors duration-200 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:outline-none outline-offset-2 dark:focus:ring-offset-gray-900',
                    ...
                    <div class="flex flex-col gap-2 items-end shrink-0">
                        @if (!$n->read_at)
                            <button type="button" wire:click="markAsRead('{{ $n->id }}')"
                                class="min-h-11 min-w-11 px-3 py-2 text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-lg focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:outline-none outline-offset-2 dark:focus:ring-offset-gray-800 transition-colors duration-150"
                        ...
                        <button type="button" wire:click="deleteNotification('{{ $n->id }}')"
                            ...
                            class="min-h-11 min-w-11 px-3 py-1 text-xs font-medium text-danger-600 dark:text-danger-400 hover:text-danger-800 dark:hover:text-danger-300 hover:bg-danger-50 dark:hover:bg-danger-900/20 rounded-lg focus:outline-none focus-visible:ring-3 focus-visible:ring-danger-500 focus-visible:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors duration-150"
