...
<div id="dashboard-statistics" class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4" role="region" aria-label="{{ __('portal.dashboard_statistics') }}">
    {{-- My Open Tickets --}}
    <article class="bg-white dark:bg-slate-800 overflow-hidden shadow-card rounded-lg theme-transition border border-slate-200 dark:border-slate-700">
        <div class="p-5">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-slate-600 dark:text-slate-300 truncate">
                            {{ __('portal.my_open_tickets') }}
                        </dt>
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-heading font-semibold text-slate-900 dark:text-white">
        ...
        <div class="bg-slate-50 dark:bg-slate-700/50 px-5 py-3 border-t border-slate-200 dark:border-slate-700">
            <a href="{{ route('helpdesk.authenticated.tickets') }}"
                class="inline-flex items-center min-h-11 px-3 py-2 text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-800 rounded-lg transition-colors"
    ...
    <article class="bg-white dark:bg-slate-800 overflow-hidden shadow-card rounded-lg theme-transition border border-slate-200 dark:border-slate-700">
        <div class="p-5">
            <div class="flex items-center">
                <div class="shrink-0 p-3 bg-warning-50 dark:bg-warning-900/30 rounded-lg">
    ...
    <article class="bg-white dark:bg-slate-800 overflow-hidden shadow-card rounded-lg theme-transition border border-slate-200 dark:border-slate-700">
        <div class="p-5">
            <div class="flex items-center">
                <div class="shrink-0 p-3 bg-danger-50 dark:bg-danger-900/30 rounded-lg">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="flex items-baseline">
                            <div class="text-2xl font-heading font-semibold {{ $this->overdueItemsCount > 0 ? 'text-danger-600 dark:text-danger-400' : 'text-slate-900 dark:text-white' }}">
    ...
    @if ($this->isApproverUser)
        <article class="bg-white dark:bg-slate-800 overflow-hidden shadow-card rounded-lg theme-transition border border-slate-200 dark:border-slate-700">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="shrink-0 p-3 bg-success-50 dark:bg-success-900/30 rounded-lg">
