<div>
    <h1>{{ __('portal.notification_preferences') }}</h1>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <fieldset class="space-y-4">
                    <legend class="sr-only">{{ __('Notification Preferences Options') }}</legend>
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="email_notifications" type="checkbox"
                                class="h-4 w-4 text-primary-600 focus-visible:ring-3 focus-visible:ring-primary-500 border-gray-300 rounded" checked>
                        </div>
                ...
                <div class="mt-6">
                    <button type="button"
                        class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-primary-700 focus:bg-primary-700 active:bg-primary-900 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 transition ease-in-out duration-150">
                        {{ __('Save Preferences') }}
                    </button>
                </div>
            </div>
