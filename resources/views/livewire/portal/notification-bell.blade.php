...
<div class="relative" x-data="{ open: $wire.entangle('open') }" @keydown.escape.window="open = false" @click.away="open = false">
    ...
    <button type="button" wire:click="toggleDropdown"
        class="relative inline-flex items-center justify-center min-h-11 min-w-11 p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-800 transition-colors duration-200"
        ...
        @if ($notifications && $notifications->count() > 0)
            <div class="p-2 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ Route::has('notifications') ? route('notifications') : '#' }}"
                    class="block w-full text-center text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-800 transition-colors duration-150">
