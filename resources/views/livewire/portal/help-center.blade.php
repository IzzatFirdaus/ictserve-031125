...
<div class="space-y-6">
    ...
    <div class="mx-auto max-w-2xl">
        <div class="relative">
            ...
            <input type="search" wire:model.live.debounce.300ms="search"
                class="block w-full rounded-lg border-gray-300 pl-10 pr-12 focus:border-primary-500 focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-primary-500"
    ...
    @if ($selectedCategory)
        <div class="flex items-center justify-between">
            ...
            <button type="button" wire:click="selectCategory(null)"
                class="inline-flex items-center px-3 py-2 text-sm text-primary-600 hover:text-primary-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-offset-2 rounded-lg">
            ...
            @foreach ($articles as $article)
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
                    <h3 class="text-lg font-medium text-gray-900">
                        <a href="#"
                            class="hover:text-primary-600 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-offset-2 rounded-lg">
                            {{ $article['title'] }}
                        </a>
                    </h3>
    ...
    @else
        ...
        <div class="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12 text-center">
            ...
            @if ($search || $selectedCategory)
                <button type="button" wire:click="clearSearch"
                    class="mt-4 inline-flex items-center rounded-lg border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-offset-2">
            ...
            <div>
                ...
                <div class="space-y-3">
                    @foreach ($popularArticles as $article)
                        <a href="#"
                            class="block rounded-lg border border-gray-200 bg-white p-4 hover:border-primary-500 hover:shadow-md transition-all focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-offset-2">
        ...
        <div class="flex items-start">
            ...
            <div class="ml-4 flex-1">
                ...
                <a href="{{ route('contact') }}"
                    class="mt-3 inline-flex items-center rounded-lg border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus:ring-offset-2">
                    {{ __('portal.help.contact_support') }}
