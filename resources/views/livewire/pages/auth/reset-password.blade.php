    ...
    <form wire:submit="resetPassword">
        ...
        <div>
            ...
            <x-text-input wire:model="email" id="email"
                ...
                type="email" name="email" required aria-required="true" autofocus autocomplete="username" />
        ...
        <div class="flex items-center justify-end mt-4">
            <x-primary-button
                class="min-h-11 px-6 rounded-lg focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500">
                {{ __('Reset Password') }}
            </x-primary-button>
        </div>
    </form>
