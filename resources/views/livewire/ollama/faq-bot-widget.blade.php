            ...
            <div class="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                <form wire:submit="submitQuery" class="space-y-3">
                    ...
                    <div class="flex space-x-2">
                        ...
                        {{-- Send Button --}}
                        <button type="submit"
                            class="px-4 py-2 bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 text-white rounded-md transition-colors focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 min-h-10 min-w-10 flex items-center justify-center"
                            {{ $isLoading ? 'disabled' : '' }}
