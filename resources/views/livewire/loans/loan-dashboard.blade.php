    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <x-ui.card variant="portal" class="border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
            <div class="flex items-center justify-between">
                ...
                <div class="rounded-full border border-blue-500/30 bg-blue-500/10 p-3 text-blue-300" aria-hidden="true">
        ...
        <x-ui.card variant="portal" class="border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
            <div class="flex items-center justify-between">
                ...
                <div class="rounded-full border border-amber-500/30 bg-amber-500/10 p-3 text-amber-300" aria-hidden="true">
                    <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <x-ui.card variant="portal" class="border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
            <div class="flex items-center justify-between">
                ...
                <div class="rounded-full border border-red-500/30 bg-red-500/10 p-3 text-red-300" aria-hidden="true">
                    <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <x-ui.card variant="portal" class="border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
            <div class="flex items-center justify-between">
                ...
                <div class="rounded-full border border-emerald-500/30 bg-emerald-500/10 p-3 text-emerald-300" aria-hidden="true">
                    <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <x-ui.card variant="portal" class="space-y-4 border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <a href="{{ route('loan.guest.apply') }}"
                class="flex min-h-11 items-center gap-3 rounded-lg border border-slate-800/80 bg-slate-900/70 p-4 text-slate-100 shadow-lg shadow-slate-950/40 transition hover:bg-slate-900/60 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-950"
                aria-label="{{ __('loan.dashboard.new_application') }}">
                <svg class="h-8 w-8 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="{{ route('loan.history') }}"
                ...
                <svg class="h-8 w-8 text-emerald-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
            ...
            <a href="{{ route('loans.assets.available') }}"
                ...
                <svg class="h-8 w-8 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            <div class="min-w-0">
                                <h3 class="font-semibold text-slate-100">
                                    <a href="{{ route('loan.authenticated.show', $loan) }}" class="text-blue-400 hover:text-blue-300">
