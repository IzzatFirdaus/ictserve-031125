        ...
        <x-ui.card variant="portal" class="space-y-4 border-slate-800 bg-slate-900/40 shadow-lg shadow-slate-950/40">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <a href="{{ route('loan.guest.apply') }}"
                    class="flex items-center gap-3 rounded-lg border border-slate-800/80 bg-slate-900/70 p-4 text-slate-100 shadow-lg shadow-slate-950/40 transition hover:bg-slate-900/60 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-950 min-h-11"
