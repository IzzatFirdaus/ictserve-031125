        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('loan.guest.tracking', ['applicationNumber' => request('reference')]) }}" 
                   class="inline-flex min-h-11 items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-3 focus-visible:ring-primary-500">
                    {{ __('loan.success.track_application') }}
                </a>
                <a href="{{ url('/') }}" 
                   class="inline-flex min-h-11 items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-3 focus-visible:ring-primary-500">
