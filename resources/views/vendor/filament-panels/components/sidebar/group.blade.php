{{-- trace: D03-FR-018.3; D12 §4.1; D14 §2.2 --}}
@props([
    'active' => false,
    'collapsible' => true,
    'icon' => null,
...
@php
    ...
    $groupToggleId = $label
        ? \Illuminate\Support\Str::slug('sidebar-group-' . $label)
        : null;
@endphp
    ...
    @if ($label)
        @if ($collapsible)
            ...
            >
                ...
                <span class="fi-sidebar-group-collapse-icon" aria-hidden="true">
