...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 py-12 md:py-16 lg:py-20 border-b border-gray-100 dark:border-gray-800 theme-transition" aria-labelledby="hero-heading">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6">
                <div class="col-span-4 md:col-span-8 lg:col-span-12 text-center space-y-6">
                    ...
                    <h1 id="hero-heading"
                        class="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-gray-900 dark:text-gray-100 tracking-tight">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400"><span class="sr-only">{{ __('Kod Rujukan') }}:</span>PK.(S).MOTAC.07
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="main-content" class="py-12 md:py-16 bg-slate-50 dark:bg-gray-800 theme-transition" aria-labelledby="services-heading">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6 lg:gap-8">
                <article
                    class="col-span-4 md:col-span-4 lg:col-span-4 bg-white dark:bg-gray-800 rounded-lg shadow-card dark:shadow-dropdown hover:shadow-dropdown transition-shadow duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
                    <div class="p-6 md:p-8 flex-1 flex flex-col items-center text-center space-y-4">
                        ...
                        <div>
                            <h3 class="text-xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-2">{{ __('Aduan ICT') }}</h3>
                            <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                                {{ __('Laporkan kerosakan perkakasan, perisian, atau rangkaian untuk tindakan segera.') }}
                            </p>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400">PK.(S).MOTAC.07.(L1)</p>
                    </div>
                    <div class="p-4 md:p-6 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                ...
                <article
                    ...
                    <div class="p-6 md:p-8 flex-1 flex flex-col items-center text-center space-y-4">
                        ...
                        <div>
                            <h3 class="text-xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-2">{{ __('Pinjaman Aset') }}</h3>
                            <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                                {{ __('Mohon pinjaman peralatan ICT seperti komputer riba dan projektor.') }}</p>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400">PK.(S).MOTAC.07.(L3)</p>
                    </div>
                    <div class="p-4 md:p-6 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                ...
                <article
                    class="col-span-4 md:col-span-8 lg:col-span-4 bg-white dark:bg-gray-800 rounded-lg shadow-card dark:shadow-dropdown hover:shadow-dropdown transition-shadow duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
                    <div class="p-6 md:p-8 flex-1 flex flex-col items-center text-center space-y-4">
                        <div class="h-16 w-16 bg-primary-50 dark:bg-primary-900/50 rounded-full flex items-center justify-center"
                            aria-hidden="true">
                        ...
                        <div>
                            <h3 class="text-xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-2">{{ __('Semak Status') }}</h3>
                            <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                        ...
                        <form action="{{ route('status.check') }}" method="GET" class="w-full" role="search">
                            <div class="space-y-2">
                                <label for="ticket_no"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-200 text-left">{{ __('No. Rujukan') }}</label>
                                <input type="text" id="ticket_no" name="reference"
                                    ...
                                    aria-required="true"
                                    aria-invalid="false"
                                    class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 shadow-sm focus:border-primary-500 focus:ring-3 focus:ring-primary-500 text-sm min-h-11"
                                    required>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav aria-label="{{ __('Pautan Pantas') }}">
                <ul class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <li><a href="{{ route('faq') }}"
                            class="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors min-h-11 focus:outline-none focus:ring-3 focus:ring-primary-500 focus:ring-offset-2"><x-heroicon-o-question-mark-circle
                                class="h-5 w-5 text-primary-600 dark:text-primary-400 shrink-0" aria-hidden="true" /><span
                                class="text-sm text-gray-700 dark:text-gray-300">{{ __('Soalan Lazim') }}</span></a></li>
                    <li><a href="{{ route('contact') }}"
                            class="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors min-h-11 focus:outline-none focus:ring-3 focus:ring-primary-500 focus:ring-offset-2"><x-heroicon-o-phone
                                class="h-5 w-5 text-primary-600 dark:text-primary-400 shrink-0" aria-hidden="true" /><span
                                class="text-sm text-gray-700 dark:text-gray-300">{{ __('Hubungi Kami') }}</span></a></li>
                    <li><a href="{{ route('accessibility') }}"
                            class="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors min-h-11 focus:outline-none focus:ring-3 focus:ring-primary-500 focus:ring-offset-2"><x-heroicon-o-eye
                                class="h-5 w-5 text-primary-600 dark:text-primary-400 shrink-0" aria-hidden="true" /><span
                                class="text-sm text-gray-700 dark:text-gray-300">{{ __('Kebolehcapaian') }}</span></a></li>
                    <li><a href="{{ route('privacy-policy') }}"
                            class="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors min-h-11 focus:outline-none focus:ring-3 focus:ring-primary-500 focus:ring-offset-2"><x-heroicon-o-shield-check
                                class="h-5 w-5 text-primary-600 dark:text-primary-400 shrink-0" aria-hidden="true" /><span
                                class="text-sm text-gray-700 dark:text-gray-300">{{ __('Dasar Privasi') }}</span></a></li>
                </ul>
            </nav>
        </div>
    </section>
