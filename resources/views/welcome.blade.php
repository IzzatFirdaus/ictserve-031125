...
@section('content')
    <div x-data="{
        ...
        <section class="relative bg-gray-900 py-32 md:py-40 lg:py-48 overflow-hidden" aria-labelledby="hero-heading">
                    ...
                    <div class="pt-8">
                        <form action="{{ route('status.check') }}" method="GET" class="max-w-md mx-auto" role="search">
                            <div class="flex gap-2">
                                ...
                                <button type="submit"
                                    class="px-6 py-3 bg-white text-primary-600 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-3 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600 min-h-12 flex items-center gap-2">
            ...
            <div class="absolute bottom-0 left-0 right-0 z-10">
                <svg class="w-full h-12 md:h-16 text-gray-50 dark:text-gray-900" viewBox="0 0 1440 48" fill="none"
        ...
        <section id="main-content" class="py-16 md:py-20 bg-gray-50 dark:bg-gray-900 theme-transition"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{-- Aduan ICT Card --}}
                    <article
                        class="bg-white dark:bg-gray-800 rounded-lg shadow-card dark:shadow-dropdown hover:shadow-lg transition-all duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
                        <div class="p-6 flex-1 flex flex-col items-center text-center space-y-4">
                            ...
                            <div>
                                <h3 class="text-xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-2">
                                    {{ __('Aduan ICT') }}</h3>
                    ...
                    {{-- Semak Status Card --}}
                    <article
                        class="bg-white dark:bg-gray-800 rounded-lg shadow-card dark:shadow-dropdown hover:shadow-lg transition-all duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col md:col-span-2 lg:col-span-1">
        ...
        {{-- FAQ Section --}}
        <section class="py-16 md:py-20 bg-white dark:bg-gray-800 theme-transition" aria-labelledby="faq-heading">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 id="faq-heading"
                        class="text-3xl md:text-4xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-4">
                        {{ __('Soalan Lazim') }}
                    </h2>
                    ...
                    <div
                        ...
                        <button @click="openFaq = openFaq === 1 ? null : 1"
                            ...
                            <x-heroicon-s-chevron-down
                                class="h-5 w-5 text-gray-500 dark:text-gray-400 transition-transform duration-200 shrink-0"
            ...
            <div x-show="showLoginModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
                ...
                {{-- Backdrop --}}
                <div class="fixed inset-0 bg-gray-900/75 dark:bg-gray-900/90 transition-opacity" x-show="showLoginModal"
                        ...
                        <div class="px-6 py-6">
                            <div class="space-y-4">
                                ...
                                <div class="text-center">
                                    <p class="text-xl font-heading font-semibold text-gray-900 dark:text-gray-100 mb-2">
