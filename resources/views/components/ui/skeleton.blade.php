    ...
    @switch($type)
        ...
        @case('table-row')
            ...
            <div class="flex items-center gap-4 py-3">
                <div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/6 skeleton-pulse"></div>
                <div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/4 skeleton-pulse"></div>
            ...
            @default
                ...
                <div class="space-y-2">
                    @for ($i = 0; $i < $lines; $i++)
                        ...
                        @endphp
                        <div class="h-4 bg-gray-200 dark:bg-gray-700 rounded {{ $lineWidth }} skeleton-pulse"></div>
                    @endfor
                </div>
            @break
