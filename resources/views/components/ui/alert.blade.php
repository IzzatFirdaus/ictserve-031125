        ...
        @if ($dismissible)
            <div class="ml-auto pl-3">
                ...
                <button @click="show = false" type="button"
                    class="inline-flex items-center justify-center min-h-11 min-w-11 rounded-lg p-2 focus:outline-none focus:ring-3 focus:ring-offset-2 focus:ring-primary-500 {{ $config['container'] }} hover:bg-opacity-75 transition-colors duration-200"
