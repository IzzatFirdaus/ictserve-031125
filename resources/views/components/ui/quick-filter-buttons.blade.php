...
<div {{ $attributes->merge(['class' => 'flex flex-wrap items-center gap-2']) }} role="group"
    ...
    <button type="button"
        ...
        class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg min-h-11
                           ...
                           focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-3 focus-visible:ring-primary-500
                           touch-target"
    ...
    <button type="button" wire:click="$dispatch('clear-saved-filter', { context: '{{ $context }}' })"
        class="inline-flex items-center gap-1 px-2 py-1.5 text-xs font-medium min-h-11
                           ...
                           focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-3 focus-visible:ring-gray-500"
