...
@php
    ...
    $baseClasses =
        'inline-flex items-center justify-center font-medium rounded-lg transition-colors duration-200 focus-visible:outline-3 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    $variants = [
        ...
        'secondary' =>
            'bg-white text-gray-700 border-2 border-gray-300 hover:bg-gray-50 focus-visible:outline-primary-500',
        ...
        'ghost' => 'bg-transparent text-gray-700 hover:bg-gray-100 focus-visible:outline-primary-500',
    ];
...
<button type="{{ $type }}" {{ $attributes->merge(['class' => $classes]) }}
    ...
    @if ($loading) aria-busy="true" @endif style="outline-width: 3px;">
    {{-- Loading spinner --}}
    @if ($loading)
