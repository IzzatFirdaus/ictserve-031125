...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-dropdown transform transition-all sm:w-full sm:mx-auto {{ 'sm:max-w-' . $maxWidth }} max-h-screen sm:max-h-[calc(100vh-4rem)] overflow-y-auto focus-visible:outline-none"
