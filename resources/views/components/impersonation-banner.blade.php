...
@if($isImpersonating && $impersonator && $currentUser)
    <div
        role="alert"
        aria-live="polite"
        class="fixed top-0 left-0 right-0 z-50 bg-amber-400 border-b-2 border-amber-600 shadow-lg print:hidden"
        style="z-index: 9999;"
    >
            ...
            <div class="flex items-center justify-between py-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="flex-shrink-0" aria-hidden="true">
                        <svg class="h-5 w-5 text-amber-800" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                        ...
                        <span class="hidden sm:inline text-amber-800" aria-hidden="true">•</span>
                        <span class="text-sm text-amber-800">
                            {{ __('impersonation.impersonating_user', ['name' => $currentUser->name]) }}
                        </span>
                        <span class="hidden md:inline text-amber-800" aria-hidden="true">•</span>
                        <span class="hidden md:inline text-xs text-amber-700">
