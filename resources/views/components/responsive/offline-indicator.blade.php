    ...
    <div x-show="!online && !dismissed" x-transition:enter="transition ease-out duration-300 transform"
        ...
        <div class="flex items-center justify-between px-4 py-2 max-w-7xl mx-auto">
            ...
            <button type="button" @click="dismiss()"
                class="shrink-0 p-1 rounded-full hover:bg-warning-600 focus:outline-none focus-visible:ring-3 focus-visible:ring-white focus-visible:ring-offset-2 focus:ring-offset-warning-500"
