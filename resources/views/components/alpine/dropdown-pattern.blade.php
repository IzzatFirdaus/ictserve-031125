...
<div x-data="{ open: false }" @click.away="open = false">
    <button
        ...
        aria-haspopup="true"
        :aria-expanded="open"
        class="inline-flex items-center min-h-11 px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
    >
        Menu
    ...
    >
        <div class="py-1">
            ...
            <a href="#" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 min-h-11 flex items-center">Item 2</a>
            <a href="#" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 min-h-11 flex items-center">Item 3</a>
        </div>
    </div>
</div>
