...
--}}
<button
    {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center justify-center px-4 py-2 min-h-11 min-w-11 bg-danger-500 border border-transparent rounded-md font-semibold text-sm text-white shadow-button hover:bg-danger-600 active:bg-danger-700 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200']) }}>
    {{ $slot }}
</button>
