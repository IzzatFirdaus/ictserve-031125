        ...
        @foreach($items as $index => $item)
            ...
            <li class="inline-flex items-center">
                ...
                @elseif($hasUrl)
                    <a
                        href="{{ $item['url'] }}"
                        class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-blue-600 focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-primary-500 rounded-lg px-2 py-1 min-h-11"
                    >
