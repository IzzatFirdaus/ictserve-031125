    ...
    <ul class="fixed top-0 left-0 z-50 bg-motac-blue text-white p-4 rounded-br-lg shadow-lg">
        <li class="mb-2">
            <a id="skip-to-content" href="#main-content"
                class="flex items-center px-4 py-3 bg-white text-motac-blue rounded-md hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-motac-blue min-h-[44px] min-w-[44px] font-medium"
                accesskey="m">
