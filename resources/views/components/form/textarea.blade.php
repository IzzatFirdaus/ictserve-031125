...
<div class="{{ $attributes->get('class') }}">
    ...
    <div class="relative rounded-md shadow-sm">
        <textarea
            ...
            rows="{{ $rows }}"
            {{ $attributes->merge([
                'class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white' . 
