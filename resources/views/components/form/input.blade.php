...
@php
    ...
    $inputClasses =
        'block w-full rounded-md shadow-sm sm:text-sm min-h-[44px] px-3 py-2 ' .
        'border transition-colors duration-200 ' .
        'focus:ring-2 focus:ring-offset-0 ' .
        'dark:bg-gray-800 dark:text-white ' .
        ($hasError
            ? 'border-danger-500 text-danger-900 placeholder-danger-400 focus:border-danger-500 focus:ring-danger-500/20 dark:border-danger-400 dark:text-danger-100'
