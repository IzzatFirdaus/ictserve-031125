        ...
        <header class="bg-primary-600 text-white shadow-md sticky top-0 z-50" x-data="{ open: false }" role="banner">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <nav class="hidden md:flex space-x-8" aria-label="Main Navigation">
                        ...
                        <a href="#status" class="text-white hover:text-blue-200 px-3 py-2 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600">
                            {{ __('Semak Status') }}
                        </a>
                        <a href="#directory" class="text-white hover:text-blue-200 px-3 py-2 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600">
                            {{ __('Direktori') }}
                        </a>
                    </nav>
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        @auth
                        <a href="{{ route('dashboard') }}" class="ml-4 px-4 py-2 border border-white rounded-md text-sm font-medium text-white hover:bg-white hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600">
                            Dashboard
                        </a>
                        @else
            ...
            <div x-show="open" x-cloak class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="/" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary-700 hover:text-white">
                        {{ __('Utama') }}
                    </a>
                    <a href="#status" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary-700 hover:text-white">
                        {{ __('Semak Status') }}
                    </a>
                    <a href="#directory" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary-700 hover:text-white">
                        {{ __('Direktori') }}
                    </a>
                </div>
                <div class="pt-4 pb-4 border-t border-primary-700">
                    ...
                    <div class="mt-3 px-2 space-y-1">
                        <a href="{{ route('dashboard') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary-700 hover:text-white">
                            Dashboard
                        </a>
                    </div>
                    @endauth
        ...
        <footer class="bg-gray-800 text-gray-300 py-8" role="contentinfo">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6">
                    <a href="#" class="text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 rounded-sm">
