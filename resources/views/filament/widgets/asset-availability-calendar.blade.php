<x-filament-widgets::widget>
    <x-filament.components::widget-card title="Asset Availability Calendar" description="Kalendar ketersediaan aset"
        icon="heroicon-o-calendar-days" color="info" :interactive="false">
        ...
        <div class="space-y-4" data-testid="asset-availability-calendar">
            ...
            <div class="flex flex-wrap gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg"
                ...
                @foreach ($legend as $item)
                    <div class="flex items-center gap-2" data-testid="asset-legend-item"
            ...
            {{-- Calendar Container --}}
            <div id="asset-calendar" class="min-h-[600px]" data-testid="asset-calendar-grid"></div>
        </div>
