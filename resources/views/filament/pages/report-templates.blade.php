                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @php
                                ...
                                $buttonClass = match($template['color']) {
                                    'primary' => 'bg-primary-600 hover:bg-primary-700 focus-visible:ring-3 focus-visible:ring-primary-500',
                                    'success' => 'bg-success-600 hover:bg-success-700 focus-visible:ring-3 focus-visible:ring-success-500',
                                    'warning' => 'bg-warning-600 hover:bg-warning-700 focus-visible:ring-3 focus-visible:ring-warning-500',
                                    'danger' => 'bg-danger-600 hover:bg-danger-700 focus-visible:ring-3 focus-visible:ring-danger-500',
                                    'info' => 'bg-info-600 hover:bg-info-700 focus-visible:ring-3 focus-visible:ring-info-500',
                                    default => 'bg-gray-600 hover:bg-gray-700 focus-visible:ring-3 focus-visible:ring-gray-500',
                                };
                            @endphp
                            ...
                            <button 
                                ...
                                class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-white {{ $buttonClass }} focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 transition-colors duration-200 disabled:opacity-50 min-h-11"
                            >
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button 
                        ...
                        class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-3 focus-visible:ring-gray-500 transition-colors duration-200 min-h-11"
                    >
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-warning-600">50MB</div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Had Saiz Fail</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-secondary-600">Auto</div>
