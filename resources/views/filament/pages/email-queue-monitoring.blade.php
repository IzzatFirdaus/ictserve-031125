<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-danger-50 dark:bg-danger-900/20 border-l-4 border-danger-500 p-4" role="alert">
            <div class="flex">
                <svg class="w-5 h-5 text-danger-500 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                </svg>
                <div>
                    <p class="text-sm font-medium text-danger-800 dark:text-danger-200">Queue Worker Unavailable</p>
                    <p class="mt-1 text-sm text-danger-700 dark:text-danger-300">Queue worker status unavailable. Check queue configuration and ensure workers are running.</p>
                </div>
            </div>
        </div>
        @endif
