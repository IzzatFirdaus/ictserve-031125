            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                    <button
                        ...
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeFilter === 'all' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                    >
                        All Notifications
                    ...
                    <button
                        ...
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeFilter === 'unread' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                    >
                        Unread
                    ...
                    <button
                        ...
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $activeFilter === 'read' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                    >
                        Read
                    </button>
                </nav>
                                ...
                                <div class="w-10 h-10 rounded-full flex items-center justify-center
                                    {{ $notification['color'] === 'success' ? 'bg-success-100 text-success-600' : 
                                       ($notification['color'] === 'danger' ? 'bg-danger-100 text-danger-600' : 
                                        ($notification['color'] === 'warning' ? 'bg-warning-100 text-warning-600' : 
                                         ($notification['color'] === 'info' ? 'bg-primary-100 text-primary-600' : 'bg-gray-100 text-gray-600'))) }}">
                                    @php
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @elseif($notification['priority'] === 'urgent')
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-danger-600 text-white">
                                                Urgent
                                            </span>
                                        @endif
                                ...
                                <div class="mt-3 flex items-center space-x-4">
                                    @if($notification['action_url'])
                                        <button
                                            ...
                                            class="text-sm font-medium text-primary-600 hover:text-primary-500 min-h-11 flex items-center"
                                        >
                                    ...
                                    @if(!$notification['is_read'])
                                        <button
                                            ...
                                            class="text-sm font-medium text-gray-600 hover:text-gray-500 min-h-11 flex items-center"
                                        >
                                            Mark as Read
                                        </button>
                                    @else
                                    ...
                                    <button
                                        ...
                                        class="text-sm font-medium text-danger-600 hover:text-danger-500 min-h-11 flex items-center"
                                    >
                                        Delete
                                    </button>
                                </div>
            ...
            @if(count($notifications) >= 50)
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                    <button
                        ...
                        class="w-full text-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus-visible:ring-3 focus-visible:ring-offset-2 focus-visible:ring-primary-500 min-h-11"
                    >
