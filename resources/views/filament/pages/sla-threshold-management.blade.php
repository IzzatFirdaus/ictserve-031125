    ...
    <div class="space-y-6">
            ...
            <x-filament::card>
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">95.2%</div>
                    </div>
                </div>
            </x-filament::card>
            ...
            <x-filament::card>
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">87.8%</div>
                    </div>
                </div>
            </x-filament::card>
        ...
        <x-filament::card>
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400 space-y-3">
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-gray-100 mb-1">Masa Respons vs Penyelesaian:</h4>
                ...
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-gray-100 mb-1">Eskalasi Automatik:</h4>
                ...
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-gray-100 mb-1">Waktu Perniagaan:</h4>
                ...
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-gray-100 mb-1">Notifikasi:</h4>
