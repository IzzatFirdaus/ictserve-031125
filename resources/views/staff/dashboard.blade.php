...
<x-portal-layout>
    ...
    <div class="space-y-6">
        ...
        <div data-testid="dashboard-stats-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-ui.card data-testid="stat-card-open-tickets"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm">
            ...
            <x-ui.card data-testid="stat-card-active-loans"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm">
                <h2 class="text-sm font-medium text-slate-400">
            ...
            <x-ui.card data-testid="stat-card-pending-approvals"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm">
                <h2 class="text-sm font-medium text-slate-400">
            ...
            <x-ui.card data-testid="stat-card-resolved-this-month"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm">
                <h2 class="text-sm font-medium text-slate-400">
        ...
        <div data-testid="dashboard-activity-grid" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {{-- Recent Tickets --}}
            <x-ui.card data-testid="recent-tickets-card"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm flex flex-col" :title="__('staff.dashboard.recent_tickets')">
                ...
                @else
                    <ul class="divide-y divide-slate-800 flex-1">
                        @foreach ($recentTickets as $ticket)
                            <li
                                class="py-3 flex flex-col gap-1 hover:bg-slate-800/30 transition-colors px-2 -mx-2 rounded">
            ...
            <x-ui.card data-testid="recent-loans-card"
                class="border border-slate-800 bg-slate-900/70 backdrop-blur-sm flex flex-col" :title="__('staff.dashboard.recent_loans')">
