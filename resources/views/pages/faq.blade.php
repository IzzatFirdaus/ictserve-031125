...
@section('content')
    ...
    {{-- Main Content --}}
    <section id="main-content" class="py-12 md:py-16 bg-slate-50 dark:bg-gray-800 theme-transition" aria-labelledby="faq-heading">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="faq-search" placeholder="{{ __('Taip untuk mencari...') }}"
                        class="block w-full min-h-11 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 pl-10 pr-4 py-3 shadow-sm focus:border-primary-500 focus:ring-3 focus:ring-primary-500 text-sm"
            ...
            <div class="space-y-8">
                ...
                <section aria-labelledby="helpdesk-faq-heading">
                    <div class="bg-white dark:bg-gray-900 rounded-lg shadow-card dark:shadow-dropdown border border-gray-200 dark:border-gray-700 overflow-hidden theme-transition">
                        <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 id="helpdesk-faq-heading" class="text-xl font-heading font-semibold text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-lg shadow-card dark:shadow-dropdown border border-gray-200 dark:border-gray-700 overflow-hidden theme-transition">
                        <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 id="loan-faq-heading" class="text-xl font-heading font-semibold text-gray-900 dark:text-gray-100">
                        ...
                        <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                            <div class="flex items-center gap-3">
                                <div class="h-10 w-10 bg-warning-50 dark:bg-warning-900/30 rounded-full flex items-center justify-center shrink-0"
                                    aria-hidden="true">
                                    <x-heroicon-o-information-circle class="h-5 w-5 text-warning-600 dark:text-warning-400" />
                                </div>
                                <h3 id="general-faq-heading" class="text-xl font-heading font-semibold text-gray-900 dark:text-gray-100">
                                    {{ __('Maklumat Am') }}
                                </h3>
                            </div>
                        </div>
