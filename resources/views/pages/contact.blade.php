...
@section('content')
    ...
    <section id="main-content" class="py-12 md:py-16 bg-slate-50" aria-labelledby="contact-heading">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6 lg:gap-8">
                ...
                <div class="col-span-4 md:col-span-8 lg:col-span-4 space-y-6">
                    ...
                    <article class="bg-white rounded-lg shadow-card border border-gray-200 overflow-hidden">
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="h-10 w-10 bg-primary-50 rounded-full flex items-center justify-center shrink-0"
                                    aria-hidden="true">
                                    <x-heroicon-o-map-pin class="h-5 w-5 text-primary-600" />
                                </div>
                                <h3 class="text-lg font-heading font-semibold text-gray-900">{{ __('Alamat Pejabat') }}</h3>
                            </div>
                            <address class="not-italic text-gray-700 text-sm space-y-1 leading-relaxed">
                                <p class="font-semibold text-gray-900">Bahagian Pengurusan Maklumat</p>
                    ...
                    <article class="bg-white rounded-lg shadow-card border border-gray-200 overflow-hidden">
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-heading font-semibold text-gray-900">{{ __('Saluran Hubungan') }}
                                </h3>
                            </div>
                            <dl class="space-y-4 text-sm">
                                <div>
                                    <dt class="font-medium text-gray-500">{{ __('Talian Am') }}</dt>
                                ...
                                <div>
                                    <dt class="font-medium text-gray-500">{{ __('Sokongan Helpdesk') }}</dt>
                                    <dd class="text-gray-900 font-semibold">
                                ...
                                <div>
                                    <dt class="font-medium text-gray-500">{{ __('E-mel') }}</dt>
                                    <dd>
                    ...
                    <article class="bg-white rounded-lg shadow-card border border-gray-200 overflow-hidden">
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="text-lg font-heading font-semibold text-gray-900">{{ __('Waktu Operasi') }}</h3>
                            </div>
                            <dl class="space-y-3 text-sm">
                                <div class="flex justify-between items-center">
                                    <dt class="text-gray-700">{{ __('Isnin - Jumaat') }}</dt>
                                    <dd class="font-semibold text-gray-900">8:30 PG - 5:30 PTG</dd>
                                </div>
                                <div class="flex justify-between items-center">
                                    <dt class="text-gray-700">{{ __('Rehat Tengah Hari') }}</dt>
                                    <dd class="font-semibold text-gray-900">1:00 PTG - 2:00 PTG</dd>
                                </div>
                                <div class="flex justify-between items-center">
                                    <dt class="text-gray-700">{{ __('Rehat Jumaat') }}</dt>
                                    <dd class="font-semibold text-gray-900">12:15 PTG - 2:45 PTG</dd>
                                </div>
                                <div class="flex justify-between items-center pt-3 border-t border-gray-200">
                                    <dt class="text-gray-700">{{ __('Hujung Minggu & Cuti Umum') }}</dt>
                    ...
                    <div class="grid grid-cols-4 md:grid-cols-8 gap-4 md:gap-6">
                        ...
                        @if ($helpdeskRoute)
                            <a href="{{ route($helpdeskRoute) }}"
                                class="col-span-4 group bg-white rounded-lg shadow-card hover:shadow-dropdown border border-gray-200 p-6 transition-all duration-200 focus:outline-none focus:ring-3 focus:ring-primary-500 focus:ring-offset-2">
                                <div class="flex items-center justify-between mb-3">
                                    <h4
                                        class="text-lg font-heading font-semibold text-gray-900 group-hover:text-primary-600 transition-colors">
                                        {{ __('Hantar Tiket') }}
                                    </h4>
                        ...
                        @if ($loanRoute)
                            <a href="{{ route($loanRoute) }}"
                                class="col-span-4 group bg-white rounded-lg shadow-card hover:shadow-dropdown border border-gray-200 p-6 transition-all duration-200 focus:outline-none focus:ring-3 focus:ring-success focus:ring-offset-2">
                                <div class="flex items-center justify-between mb-3">
                                    <h4
                                        class="text-lg font-heading font-semibold text-gray-900 group-hover:text-success transition-colors">
