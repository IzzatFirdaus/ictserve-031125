        ...
        'reverb' => [
            ...
            'options' => [
                'tls' => [
                    ...
                    'verify_peer' => (bool) env('REVERB_TLS_VERIFY_PEER', false),
                    'verify_peer_name' => (bool) env('REVERB_TLS_VERIFY_PEER_NAME', false),
                    'allow_self_signed' => (bool) env('REVERB_TLS_ALLOW_SELF_SIGNED', true),
                ],
            ],
            ...
            'scaling' => [
                ...
                'server' => [
                    ...
                    'database' => (int) env('REDIS_BROADCAST_DB', env('REDIS_DB', 0)),
                    'timeout' => (int) env('REDIS_TIMEOUT', 60),
                    'read_timeout' => (int) env('REDIS_READ_TIMEOUT', 60),
