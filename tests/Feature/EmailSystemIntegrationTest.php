...
class EmailSystemIntegrationTest extends TestCase
{
    ...
    #[Test]
    public function otp_email_is_sent_when_status_changes_to_ready_issuance(): void
    {
    ...
    #[Test]
    public function status_update_email_is_sent(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'user_id' => $this->user->id,
    ...
    #[Test]
    public function otp_generation_creates_valid6_digit_code(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'division_id' => $division->id,
    ...
    #[Test]
    public function otp_validation_fails_with_wrong_code(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'division_id' => $division->id,
    ...
    #[Test]
    public function otp_validation_fails_when_expired(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'division_id' => $division->id,
    ...
    #[Test]
    public function otp_attempts_are_tracked(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'division_id' => $division->id,
    ...
    #[Test]
    public function emails_are_queued_not_sent_synchronously(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'user_id' => $this->user->id,
    ...
    #[Test]
    public function guest_applications_receive_emails_at_applicant_email(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
    ...
    #[Test]
    public function authenticated_applications_receive_emails_at_user_email(): void
    {
        $division = Division::factory()->create();
        $application = LoanApplication::factory()->create([
            'user_id' => $this->user->id,
