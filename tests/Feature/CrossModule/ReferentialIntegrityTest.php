...
class ReferentialIntegrityTest extends TestCase
{
    ...
    public function test_cannot_delete_asset_with_active_helpdesk_tickets(): void
    {
    ...
    public function test_cannot_delete_asset_with_active_loan_items(): void
    {
        $asset = Asset::factory()->create();
    ...
    public function test_deleting_user_sets_null_on_tickets(): void
    {
    ...
    public function test_deleting_loan_application_cascades_to_loan_items(): void
    {
        $loan = LoanApplication::factory()->create();
    ...
    public function test_cross_module_integration_indexes_exist(): void
    {
