...
- **Tailwind CSS**: 4.1.18 (CSS-first config via `@theme`, no tailwind.config.js)
...
- **Spatie Laravel Permission**: 6.24.0 (RBAC: staff/admin/superuser; approvers via signed email tokens)
...
- **PHPUnit**: 11.5.46 (tests must be PHPUnit classes; no Pest)
