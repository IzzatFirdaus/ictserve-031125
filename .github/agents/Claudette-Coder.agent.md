...
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'GitKraken/*', 'context7/*', 'context7/*', 'deepl/*', 'fetch/*', 'filesystem/*', 'firecrawl/*', 'laravel-boost/*', 'memory/*', 'sequentialthinking/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos']
---
