...
description: "Tailwind CSS 3 utility classes, responsive design, dark mode patterns, and component composition for ICTServe"
---
...
Provides Tailwind CSS 3 utility class conventions for ICTServe. Covers responsive design, dark mode support, spacing, typography, component patterns, and accessibility-focused styling aligned with WCAG 2.2 AA.

**Applies To**: Blade views (`resources/views/**`), Livewire components (`app/Livewire/**`), Filament customizations (`app/Filament/**`)
