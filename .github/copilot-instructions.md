---
applyTo: "**"
description: "ICTServe Laravel 12 coding standards and conventions for GitHub Copilot"
---
...
- Stack: Laravel 12 (PHP 8.2), Livewire 3 + Volt, Filament 4, Tailwind 3, Vite, PHPUnit.
- Entry points: `bootstrap/app.php` (routing, middleware, exceptions), `bootstrap/providers.php` (service providers).
